    ...
    export default {
        ...
        methods: {
            increaseAge() {
                ...
                // Vue 自动为 methods 中的方法绑定了永远指向组件实例的 this（通过 this 可以直接调用到 data 中定义的状态）
                this.age++;
            },
...
<template>
    <div>
        ...
        <!-- 使用 computed 选项中定义的方法 -->
        <!-- 当成属性来使用，即：计算属性本质上就是一个具有缓存性质的属性 -->
        <!-- 缓存性质的属性：只要计算属性依赖的值没有发生改变，不管调用几次计算属性中定义的方法，计算属性中的方法，只会执行一次 -->
